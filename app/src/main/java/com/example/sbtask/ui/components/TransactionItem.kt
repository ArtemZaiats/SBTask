...
fun TransactionItem(transaction: Transaction) {
    Row(
            ...
            Column(
                ...
                Text(
                    ...
                    Text(
                        ...
                        modifier = if (!transaction.card?.cardLast4.isNullOrEmpty()) Modifier else Modifier
                            .height(0.dp)
                            .width(0.dp)
                    )
        ...
        Row {
            ...
            Image(painterResource(id = R.drawable.ic_receipt), contentDescription = "receipt image")
        }
    }

...
android {
    namespace = "com.example.sbtask"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.sbtask"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.navigation:navigation-compose:${rootProject.extra["lifecycle_compose_version"]}")
